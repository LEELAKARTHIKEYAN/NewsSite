  ...
  return (
    ...
    <div className="showcase">
      <div className="overlay px-5">
          <h1 className= "text-4xl font-bold text-white text-center mb-4 capitalize lg:text-5xl">NY INSHORTS</h1>
          <h3 className= "text-4xl text-white text-center mb-4 capitalize ">View news articles about {term}</h3>
